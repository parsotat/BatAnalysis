...
def _add_additional_info(file):
    """
    To the survey catalog files generated by batcelldetect, add additional information such as GLAT, GLON
    ...
    def _detect_sources(self, input_dict=None):
        ...
        for ind in range(len(all_images)):
            ...
            if len(source_data) > 0:
                ...
                _add_additional_info(batcelldetect_input_dict["outfile"])
