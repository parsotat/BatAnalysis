...
def plot_unknown_sources(batsurvey_object, dest_dir=None, save_ind=False, save_coll=True):
    """
    ...
    :return: None
    """
    unknown_source_catalogs = batsurvey_object.unknown_sources_catalogs
